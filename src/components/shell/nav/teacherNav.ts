...
export const teacherNavItems: ShellNavItem[] = [
  ...
  { to: '/dashboard/teacher/community', label: TERMS.community, icon: MessageSquare, placement: ['sidebar', 'more'] },
  {
  ...
  { to: '/dashboard/teacher/coupons', label: 'Promotions', icon: Ticket, placement: ['sidebar', 'more'] },
  { to: '/dashboard/teacher/earnings', label: 'Earnings', icon: IndianRupee, placement: ['sidebar', 'more'] },
  { to: '/dashboard/teacher/competitions', label: TERMS.competitions, icon: Trophy, placement: ['sidebar', 'more'] },
  {
